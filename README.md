...
- **인터렉티브 메인 이미지**
  - 마우스의 자표를 수집해서 마우스의 위치에 따라 인터렉티브하게 움직이는 영화 포스터를 메인 페이지에 추가

<br>

- **다양한 기준에 의한 영화 추천**
  - 날씨 기반 추천, 최근 유저들이 좋아하는 영화 추천, 비슷한 또래의 유저들이 좋아하는 영화 추천 등 11가지의 추천 서비스 제공

<br>

- **프로그래스 바**
  - 우측의 스크롤 바를 없앤 대신 네브바 밑으로 스크롤의 정도를 표시하는 프로그래스 바 추가

<br>

- **캐러셀**
  - 추천 종류마다 다양한 영화를 표시하기 위해 마우스로 슬라이드 가능한 캐러셀 추가
  - 영화 카드에 마우스 오버시 간략한 정보 표시
  - 클릭시 상세 페이지로 이동
...
- **게시글 검색기능**
  - 필터에 맞춰 검색 가능
    - 제목, 내용, 제목 + 내용, 작성자
  - 검색 이후 게시판을 바꿔도 검색 정보 유지
  - 게시판 바꾼후 검색을 할 경우, 전체 게시판으로 초기화
